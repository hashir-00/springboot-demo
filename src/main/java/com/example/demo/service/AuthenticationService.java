...
import com.example.demo.web.exception.ValidationException;
...
public class AuthenticationService {
    ...
    public ResponseEntity<LoginResponse> login(LoginUser loginUserDto) {
        ...
        try {
            ...
            logger.info("Refresh token generated successfully for user with email: {}", loginUserDto.getEmail());
    ...
    public ResponseEntity<LogoutResponse> signout(HttpServletRequest request) {
        ...
        try {
            ...
            Users user =this.userRepository.findByEmail(userName).orElseThrow(() -> new AuthenticationException("User not found"));
